                ...
                <div class="flex items-start justify-between p-4 rounded-t">
                    <div>
                        <h3 class="text-xl font-semibold text-gray-300">
                            {{ trans('lang.labels.manage_module') }}
                        </h3>
                        <h3 class="text-base text-gray-400">{{ trans("lang.labels.are_you_sure_you_want_to_delete_this_module") }}</h3>
                    </div>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            axios.post('/api/delete-group-module/' + this.groupId, formData)
                .then((res) => {
                    this.isCloseDelete();
                    let notification = {
                        heading: 'success',
