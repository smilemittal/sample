            ...
            <div class="relative rounded-lg shadow bg-body">
                ...
                <div class="flex items-start justify-between p-4 rounded-t">
                    <div>
                        ...
                        <h5 class="text-base text-gray-400">{{ trans('lang.labels.are_you_sure_you_want_to_delete_this_member') }}</h5>
                    </div>
                    ...
                    <div class="flex items-center justify-end p-6 space-x-2 rounded-b dark:border-gray-600">
                        ...
                        <button class="text-btnSubmitText bg-btnSubmitBg rounded-lg text-sm font-medium px-5 py-2.5" @click="submitForm()">
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            axios.post('/api/remove-learning-Path-memeber/' + this.learningPathId, formData)
                .then((res) => {
                    this.isCloseDelete();
                    let notification = {
                        heading: 'success',
