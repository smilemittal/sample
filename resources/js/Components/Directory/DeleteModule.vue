            ...
            <div class="relative rounded-lg shadow bg-body">
                ...
                <div class="flex items-start justify-between p-4 rounded-t">
                    <div>
                        ...
                        <h3 class="text-base text-gray-400 mt-2">{{ trans('lang.labels.are_you_sure_you_want_to_delete_the_module')  }}</h3>
                    </div>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            axios.post('/api/delete-directory-module/' + this.id, { 'directory_id':this.directory_id })
                .then((res) => {
